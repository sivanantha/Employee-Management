...
public interface EmployeeService {
    ...
    /**
     * Checks if the specified salary is non negative.Minimum salary allowed
     * is 0. Maximum of 20 digits allowed. Commas are not allowed. Allows
     * one or two decimal points. (e.g) 8000.50,30000.6. Trailing and 
